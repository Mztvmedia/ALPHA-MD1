...
module.exports = { session: process.env.SESSION_ID || 'keith',
    ...
    GURL: process.env.GURL  || "https://chat.whatsapp.com/KhMiUEz6im74iDDtsNJ3xC",
    WEBSITE :process.env.GURL || "https://chat.whatsapp.com/KhMiUEz6im74iDDtsNJ3xC",
    CAPTION : process.env.CAPTION || "꧁𝑬𝒍𝒐𝒏 𝑴𝒖𝒔𝒌 𝑻𝑽꧂",
